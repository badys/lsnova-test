...
HashSet is used to gather visited vertices. 
Double ```for``` loop is used to check every value of each pair. 
If new value is added to the Set the counter is incremented and the list is recursively checked for adjacent vertices.  
